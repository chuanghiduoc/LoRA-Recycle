...
import numpy as np
# Windows compatible path - pointing to split CSV files
SPLIT_PATH = osp.join(osp.dirname(osp.dirname(__file__)), 'data', 'cropdiseases', 'splits')
os.makedirs(SPLIT_PATH, exist_ok=True)

def identity(x):
    return x

class cropdiseases(Dataset):
    """ Usage:
    """
...
class cropdiseases_Specific(Dataset):
    """ Usage:
    """
